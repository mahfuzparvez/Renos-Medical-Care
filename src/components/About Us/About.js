            ...
            <div className='container mt-4' id="inputField">
                ...
                <div className='w-75 my-4 ms-5'>
                    <form onSubmit={formClear}>
                        ...
                        <Button className="mt-4 w-25" type="submit" varrinte="info"><x-carbon-send-alt-filled /><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send-fill" viewBox="0 0 16 16">
